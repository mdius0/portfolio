...
export default function Page({ params: { id } }: { params: { id: string } }) {
    ...
    return (
        <div className="mx-auto max-w-7xl flex flex-col items-center justify-center">
            ...
            <section className="flex flex-col items-center justify-center h-screen bg-zinc-900 w-full relative p-16 max-md:p-4 gap-4 hero">
                <div className="absolute bottom-2 border-2 p-2 border-white flex items-center text-white justify-center gap-2">
                    <ArrowDown />
                </div>
                <div className="w-full flex items-center justify-start absolute top-4 px-16 max-md:px-8">
                ...
                <div className="w-full h-full flex flex-col items-center gap-2 justify-center">
                    <div className="h-[80%] max-md:h-[15rem] w-full bg-white max-md:mt-8"></div>
            ...
            <section className="flex flex-col items-center justify-start h-screen bg-zinc-900 w-full relative p-8">
                <h1 className="text-5xl max-md:text-2xl font-bold text-white text-start w-full my-4">Synopsis</h1>
            </section>
            <section className="flex flex-col items-center justify-start h-screen bg-zinc-900 w-full relative p-8">
                <h1 className="text-5xl max-md:text-2xl font-bold text-white text-start w-full my-4">Commits</h1>
                <div>Timeline</div>
            </section>
        </div>
    )
